...
<script type="text/javascript">
    $(function() {
        ...
        $("#showAddModalBtn").click(function() {
            ...
            // addModal 为自定义的模态框的ID
            //函数的使用可以查看bootstrap的官网
            $("#addModal").modal("show");
        ...
        // ①首先找到所有“动态生成”的元素所附着的“静态”元素（父标签）
        // ②on()函数的第一个参数是事件类型
        // ③on()函数的第二个参数是找到真正要绑定事件的元素的选择器
        // ③on()函数的第三个参数是事件的响应函数
        // 使用选择器，为整个类别添加click响应
        $("#rolePageBody").on("click", ".pencilBtn", function() {
            // 打开模态框
            $("#editModal").modal("show");

            // 获取表格中当前行中的角色名称     $(this)为jQuery对象（pencilBtn）
            //  三个button标签为buttonTd的子标签，buttonTd的前一个标签为roleNameTd标签
