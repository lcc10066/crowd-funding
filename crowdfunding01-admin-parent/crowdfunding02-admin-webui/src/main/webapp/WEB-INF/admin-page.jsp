...
// 		console.log('生成页码导航条的函数之前')
    ...
    function initPagination() {
        ...
        var _items_per_page = ${requestScope.pageInfo.pageSize};
        var _current_page = ${requestScope.pageInfo.pageNum - 1};

        var properties = {
            num_edge_entries: 3, // 边缘页数
            num_display_entries: 5, // 主体页数
            callback: pageSelectCallback, // 指定用户点击“翻页”的按钮时跳转页面的回调函数
            items_per_page: _items_per_page, // 每页要显示的数据的数量
            current_page: _current_page, // Pagination内部使用pageIndex来管理页码，pageIndex从0开始，pageNum从1开始，所以要减一
            prev_text: "上一页", // 上一页按钮上显示的文本
            next_text: "下一页" // 下一页按钮上显示的文本
        };

        // 需要注释掉jquery.pagination.js中该回调函数的调用【opts.callback(current_page, this);  】，否则会形成死循环
...
<%--                                            <td>${myStatus.count }</td>--%>
                                            ...
                                            <td>
                                                ...
                                                <a href="admin/remove/${admin.id }/${requestScope.pageInfo.pageNum }/${param.keyword }.html"
                                                   class="btn btn-danger btn-xs" onclick="deleteOne()">
                                                    <i class=" glyphicon glyphicon-remove"></i>
                                                </a>
                                            </td>
                                        </tr>
        ...
        <%--      分页下标的计算使用pagination来实现
                    导入pagination.css   jquery-form.min.js
                    --%>
